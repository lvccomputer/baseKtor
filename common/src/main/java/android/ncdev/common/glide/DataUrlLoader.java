            ...
            opener =
                    new DataDecoder<InputStream>() {
                        ...
                        public InputStream decode(String url) {
                            ...
                            if (url.startsWith(DATA_SCHEME_IMAGE + "/svg")) {
                                byte[] bytes = URLDecoder.decode(afterComma).getBytes();
                            ...
                            throw new IllegalArgumentException("Not a base64 or svg image data URL.");
                        }
...
//     * @param <Model> The type of Model we can obtain data for, e.g. String.
//     */
//    public static final class SvgStreamFactory<Model> implements ModelLoaderFactory<Model, InputStream> {
//
//        private final DataDecoder<InputStream> opener;
//
...
//                        public InputStream decode(String url) {
//                            if (!url.startsWith(DATA_SCHEME_IMAGE + "/svg")) {
//                                throw new IllegalArgumentException("Not a valid svg image data URL.");
//                            }
//
//                            int commaIndex = url.indexOf(',');
//                            if (commaIndex == -1) {
