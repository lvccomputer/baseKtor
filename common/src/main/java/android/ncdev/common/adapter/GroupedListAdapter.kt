package android.ncdev.common.adapter
...
abstract class GroupedListHolder(val _binding: ViewBinding, override val containerView: View) :
    RecyclerView.ViewHolder(_binding.root), LayoutContainer {
